...
class LooseMenu:
    ...
    def __init__(self, _screen, _game, color_manager, config_data):
        ...
        if not self.audio_settings["muted"]:
            self.background_musik = AudioManager(self.audio_settings["menu_background"], -1, 1,
    ...
    def loop(self):
        ...
        option = Options(self.screen, "Retry", (self.get_width(menu_text), int(13.2 * self.zoom)), self.color_manager)
